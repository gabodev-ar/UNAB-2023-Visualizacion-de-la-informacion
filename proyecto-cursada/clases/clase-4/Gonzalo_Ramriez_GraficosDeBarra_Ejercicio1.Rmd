...
diamantes %>% 
  ggplot(aes(x=corte))+ 
  geom_bar(aes(fill = claridad), position = "dodge")
...
diamantes %>% 
  ggplot(aes(x=corte))+ 
  geom_bar(aes(fill = claridad), position = "fill") +
  scale_y_continuous(labels = scales::percent_format()) #modifica las etiquetas del eje y
